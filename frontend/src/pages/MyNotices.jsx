...
import { viewNotice, delNotice } from "../api.js";
...
const MyNotices = () => {
  ...
  const fetchNotices = async () => {
    try {
      ...
      setNotices(mapped.filter((n) => n.author === username));
    } catch (err) {
  ...
  const validNotices = notices.filter((n) => n && n.id && n.title && n.short && n.full && n.category);
    ...
    return (
      <div className="bg-black text-gray-200 min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-3xl font-bold mb-4">Please log in to view your notices</h1>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="w-full h-full overflow-y-auto text-white scrollbar-hide">
      <Header/>
      <div className=" px-4 md:px-52 py-6 bg-black min-h-screen">
        {/* Tabs */}
        ...
        <div className="space-y-6 mt-6">
          {loading && (
            <div className="text-center text-gray-400 py-10">Loading notices...</div>
          )}
              ...
              {expandedId === notice.id && (
                ...
                >
                  ...
                  <div className="md:w-1/4 flex flex-col gap-3">
                    ...
                    <button
                      className="bg-red-500 px-3 py-1 rounded hover:bg-red-400 text-white w-max"
